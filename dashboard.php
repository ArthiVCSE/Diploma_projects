...
<div class="container">
    <div class="top-section">
        <p align="center" style="font-weight: bold;font-size:50px;color:  rgb(59, 200, 236);">DASHBOARD STATUS</p>
        <p align="right">
        ...
        </div><br><br><br><br><br></body>
        </html>

    <script>
  // Scroll to top right after the page loads
